...
class DateMessage
{
    public function getMessage(): string
    {
        ...
        $messages = [
            ...
            '07-15' => "Dies laboris : « Le travail ? C'est bien pour ceux qui ont rien à foutre de leur journée. »",  // Perceval (conservée)
            ...
            '01-01' => "Nouvel An : « C’est pas faux. Mais si on est équidistants du Nouvel An de l’année prochaine et de celui d’il y a un an, ça veut dire qu’on peut encore récupérer les résolutions qu’on n’a pas tenues ? »",  // Perceval, avec un raisonnement très pragmatique.
